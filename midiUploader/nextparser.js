...
/***/ (function (module, exports, __webpack_require__) {
				...
				var Midi = function () {
				  ...
				  * @param  {String}   url <!- this is now a filepath!
					...
					_createClass(Midi, [{
						...
						value: function load(url) {
							...
							return new Promise(function (success, fail) {
								...
								let path = url // '/Users/martin.micklinghoff/Downloads/50000 MIDI FILES/Television/melrosep.mid'

								// synchronouse reading
								let data = fs.readFileSync(path)
								if (data) {
									success(_this.decode(data))
								}
							...
							/*return new Promise(function (success, fail) {
								...
								request.addEventListener('load', function () {
									if (request.readyState === 4 && request.status === 200) {
										console.log('get a response ', request.response, request)
						...
						value: function decode(bytes) {
							...
							if (bytes instanceof Buffer) {
								...
								try {
									...
									// console.log(e)
									this.errors.push('call stack shit')
									// here, there are probably zero tracks so we can check against that in the calling function
									return this
								}
...
/***/ (function (module, exports) {
				...
				function MidiFile(data) {
							...
							if (eventTypeByte == 0xff) {
								...
								switch (subtypeByte) {
									case 0x00:
										...
										if (length != 2) {
											event.errors.push("Expected length for sequenceNumber event is 2, got " + length)
											//throw "Expected length for sequenceNumber event is 2, got " + length;
											console.log("Expected length for sequenceNumber event is 2, got " + length)
											event.error = true
										}
									...
									case 0x20:
										...
										if (length != 1) {
											...
											console.log("Expected length for midiChannelPrefix event is 1, got " + length)
											event.error = true
										}
									...
									case 0x2f:
										...
										if (length != 0) {
											...
											console.log("Expected length for endOfTrack event is 0, got " + length)
											event.error = true
										}
										return event;
									case 0x51:
										...
										if (length != 3) {
											...
											console.log("Expected length for setTempo event is 3, got " + length)
											event.error = true
										}
									...
									case 0x54:
										...
										if (length != 5) {
											...
											console.log("Expected length for smpteOffset event is 5, got " + length)
											event.error = true
										}
									...
									case 0x58:
										...
										if (length != 4) {
											...
											console.log("Expected length for timeSignature event is 4, got " + length)
											event.error = true
										}
									...
									case 0x59:
										...
										if (length != 2) {
											...
											console.log("Expected length for keySignature event is 2, got " + length)
											event.error = true
										}
								...
								console.log("Unrecognised MIDI event type byte: " + eventTypeByte)
								event.error = true
								// push to errors
							}
						} else {
					...
					if (headerChunk.id != 'MThd' || headerChunk.length != 6) {
						...
						console.log("Bad .mid file - header not found")
						// push to errors
					}
					...
					if (timeDivision & 0x8000) {
						...
						console.log('Expressing time division in SMTPE frames is not supported yet')
					} else {
					...
					for (var i = 0; i < header.trackCount; i++) {
						...
						if (trackChunk.id != 'MTrk') {
							...
							console.log("Unexpected chunk - expected MTrk, got " + trackChunk.id)
							errors.push('unexpected chunk')
							//return
							// push to errors
							break
						}
					...
					//console.log('returning', result.errors)
				...
				function Stream(str) {
					...
					function eof() {
						//console.log(position, str.length)
